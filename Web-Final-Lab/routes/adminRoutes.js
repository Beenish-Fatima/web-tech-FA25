...
// Apply adminOnly middleware to specific routes
// DON'T use router.use('/admin', adminOnly) - it causes issues
...
router.get('/admin/orders', adminOnly, adminController.getAdminOrders);

// Admin Order Detail
router.get('/admin/orders/:id', adminOnly, adminController.viewOrder);

// Update Order Status (AJAX endpoint)
router.put('/admin/orders/:orderId/status', adminOnly, adminController.updateOrderStatus);

// Add Product - GET
router.get('/admin/products/add', adminOnly, (req, res) => {
...
// Edit Product - GET
router.get('/admin/products/edit/:id', adminOnly, async (req, res) => {
    try {
...
router.post('/admin/products/update/:id', adminOnly, async (req, res) => {
    try {
        const product = await Product.findById(req.params.id);
        if (!product) {
            return res.redirect('/admin/products?message=' + encodeURIComponent('Product not found'));
...
router.get('/admin/products/delete/:id', adminOnly, async (req, res) => {
    try {
